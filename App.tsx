...
const App: React.FC = () => {
  ...
  const [flow, setFlow] = useState<'home' | 'request' | 'sellout' | 'reimbursement' | 'admin' | 'login'>('home');
  ...
  const isManagerFlow = flow === 'admin' || flow === 'login';
              ...
              {user ? (
                ...
                flow !== 'login' && (
                  <button
                    ...
                    className="flex items-center gap-1 bg-white text-brand-red px-4 py-1.5 rounded hover:bg-gray-100 transition text-sm font-bold shadow-sm whitespace-nowrap"
                  >
