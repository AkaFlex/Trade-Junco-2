...
const exportToCSV = (requests: TradeRequest[]) => {
  const headers = [
    ...
    'Espaço (Person.)', 'Categoria Marca', 'Fornecedor Local', 'Gráfica Atribuída (ADM)'
  ];
            ...
            <div className="p-6 space-y-6">
              ...
              {selectedRequest.requestType === 'personalizacao' && (
                <div className="bg-pink-50 p-5 rounded-2xl border border-pink-200 space-y-4">
                  ...
                  {selectedRequest.spacePhotoUrl && (
                    <div className="mt-4 pt-4 border-t border-pink-100">
                      <span className="block text-pink-500 text-xs uppercase font-bold mb-2">Foto do Local</span>
                      <a href={selectedRequest.spacePhotoUrl} target="_blank" className="inline-block relative group">
                        <img src={selectedRequest.spacePhotoUrl} className="h-32 rounded-lg border-2 border-pink-200 shadow-sm" alt="Foto do Espaço"/>
                        <div className="absolute inset-0 bg-black/50 text-white flex justify-center items-center font-bold opacity-0 group-hover:opacity-100 transition rounded-lg"><Eye className="mr-2"/> Abrir</div>
                      </a>
                    </div>
                  )}
